...
import {swords} from "@/app/swords";
import {pentacles} from "@/app/pentacles";
      ...
      featured: [
        {
          name: 'New Arrivals',
          href: '#',
          imageSrc: 'https://tailwindui.starxg.com/img/ecommerce-images/mega-menu-category-01.jpg',
          imageAlt: 'Models sitting back to back, wearing Basic Tee in black and bone.',
        },
        {
          name: 'Basic Tees',
          href: '#',
          imageSrc: 'https://tailwindui.starxg.com/img/ecommerce-images/mega-menu-category-02.jpg',
          imageAlt: 'Close up of Basic Tee fall bundle with off-white, ochre, olive, and black tees.',
        },
        {
          name: 'Accessories',
          href: '#',
          imageSrc: 'https://tailwindui.starxg.com/img/ecommerce-images/mega-menu-category-03.jpg',
      ...
      featured: [
        {
          name: 'Accessories',
          href: '#',
          imageSrc: 'https://tailwindui.starxg.com/img/ecommerce-images/home-page-03-category-01.jpg',
          imageAlt:
        ...
        },
        {
          name: 'New Arrivals',
          href: '#',
          imageSrc: 'https://tailwindui.starxg.com/img/ecommerce-images/product-page-04-detail-product-shot-01.jpg',
          imageAlt: 'Drawstring top with elastic loop closure and textured interior padding.',
        },
        {
          name: 'Artwork Tees',
          href: '#',
          imageSrc: 'https://tailwindui.starxg.com/img/ecommerce-images/category-page-02-image-card-06.jpg',
          imageAlt:
                ...
                <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                  ...
                  <div className="border-t border-gray-200 px-4 py-6">
                    <a href="#" className="-m-2 flex items-center p-2">
                      <img
                          src="https://tailwindui.starxg.com/img/flags/flag-canada.svg"
                          alt=""
